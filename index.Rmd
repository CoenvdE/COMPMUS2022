...
In the Self-Similarity matrix, the song *Losing my way* from *Tom Misch & FKJ* is analized. First we analize via a timbre SSM. Timbre can be described as the feel of a track, and what different instruments are used, but the term is hard to describe. As the timbre SS matrix shows, there are different sections in the song that repeated. The sections are as A - B - C - mix between BC - D. As we can see in the chroma SS matrix, different segments of the song have different pitch characteristics. Some repetitions are high in pitch and others are low. light means the pitch characteristics are way different there then in the rest of the song. This is the same for the end. the rest of the pattern follows the sections, as explained above.
